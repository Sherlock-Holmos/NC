cmd_lib/gen_crc32table := ccache gcc -Wp,-MD,lib/.gen_crc32table.d -Ilib -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -o lib/gen_crc32table ../lib/gen_crc32table.c  
